...
public class RobotContainer {
  ...
  // Our subsystems. For debugging purposes, Drivebase has been made public (to avoid having to use reflection)
  // When testing is complete, the private modifier should (but not must) be added.
  final Drivebase drivebase = new Drivebase(wheel, stick, 0.6);
  ...
  private final Command m_autoCommand = new AutonomousCommand(drivebase);
